...
def calcula_media(nome_base, nome_b, cont, con2, nclas, d1, d2):
    rownum = 0
    media = []  # medias de F1
...
def main():
    for i in range(1,21):
        nome_b='Wine'+str(i)
        nome_base='Wine'
        #cria_resumo(nome_b, i, out, nome_base)
        #cria_csv(nome_b,nome_base)
        calcula_media(nome_base,nome_b, cont=0,con2=0,nclas=3,d1=3,d2=2)
